...
private struct NumericTextAnimationModifier<V: Equatable>: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content
            ...
            .animation(reduceMotion ? nil : CarinhoMotion.snappy, value: value)
    }
}
...
extension View {
    ...
    func carinhoCardTransition(reduceMotion: Bool) -> some View {
        transition(CarinhoMotion.cardAppearTransition(reduceMotion: reduceMotion))
    }
}
